...
import { FaHeart, FaEye, FaCalendarAlt, FaUsers } from 'react-icons/fa';
...
const AdminMarriages = () => {
  ...
  useEffect(() => {
    ...
    const fetchPending = async () => {
      setLoading(true);
      try {
        const res = await fetch('http://localhost:3000/api/services/marriageRecords/api/marriage-records/admin/pending', {
          headers: { Authorization: `Bearer ${adminData.token}` }
        });
        if (!res.ok) throw new Error('Failed to load pending marriages');
    ...
    <div className="container-fluid px-4">
      ...
      <div className={styles.adminHeader}>
        <div className="text-center">
          ...
          <h2>Marriage Registration Management</h2>
          <p className="mb-0 opacity-75">Review and approve pending marriage certificate applications</p>
        </div>
      </div>
      ...
      <div className="row mb-4">
        <div className="col-md-3">
          <div className={styles.statsCard}>
            <div className="text-center">
              <FaHeart className="text-danger mb-2" size={30} />
        ...
        <div className="col-md-3">
          <div className={styles.statsCard}>
            <div className="text-center">
              <FaUsers className="text-warning mb-2" size={30} />
              <div className={styles.statsNumber}>
      ...
      {loading ? (
        ...
        <div className={styles.tableContainer}>
          <div className="d-flex justify-content-between align-items-center mb-4">
            <h4 className="mb-0">Pending Marriage Registrations</h4>
          ...
          {applications.length === 0 ? (
            <div className={styles.emptyState}>
              ...
              <p>All marriage registrations have been processed.</p>
            </div>
          ) : (
              ...
              <table className={`table ${styles.customTable}`}>
                <thead>
                  <tr>
                    <th>#</th>
                    <th>ID</th>
                    <th><FaHeart className="me-2" />Couple</th>
                    <th>Citizen ID</th>
